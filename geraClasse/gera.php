<?php 
    ...
    $tpl = new Template("classe.txt");
    $tpl->addFile("ENTIDADE","interface.txt"); 
    $tpl->addFile("BANCODEDADOS","banco.txt");
    $tpl->addFile("DBCLASSE","classePersonaliza.txt");
    ...
    // Salva em um arquivo 
    file_put_contents( $tabela . ".php", $conteudo); 
